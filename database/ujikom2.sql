...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Feb 2024 pada 05.14
...
(44, 'cek', 'cek', 'cek 1234', 1234),
(45, 'nathan', 'salma', 'foilm', 1234),
(65, 'milea', 'aku', 'ahmad', 1234),
(67, 'vvv', 'bbb', 'gggg', 5678),
(68, 'alam', 'hkjhkj', 'kljlj', 786),
(69, 'h-1 masgun', 'nanda', 'masgun&nanda', 2024);
...
--
ALTER TABLE `buku`
  MODIFY `BukuID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;

--
-- AUTO_INCREMENT untuk tabel `kategoribuku`
--
ALTER TABLE `kategoribuku`
  MODIFY `KategoriID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT untuk tabel `kategoribuku_relasi`
--
ALTER TABLE `kategoribuku_relasi`
  MODIFY `KategoriBukuID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `user`
  MODIFY `UserID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112245;
